# SDKWork Models Python Component Specs

This directory is the local standards index for `sdkwork-models-python`.
...
| Type | `python-package` |
| Root | `sdkwork-clawrouter/data/sdkwork-models/sdkwork-models-python` |
| Domain | `intelligence` |
| Capability | `model` |
| Languages | `python` |
