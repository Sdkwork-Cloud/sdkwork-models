...
Future<ModelCatalog> loadBundledCatalog() async {
  ...
  return loadCatalog(await _resolveDefaultCatalogRoot());
}

Future<String> _resolveDefaultCatalogRoot() async {
  var current = Directory.current;
  for (var depth = 0; depth < 8; depth++) {
    if (await File('${current.path}/sdkwork-models.json').exists()) {
      return current.path;
    }
