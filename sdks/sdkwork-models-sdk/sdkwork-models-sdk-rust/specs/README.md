# SDKWork Models Component Specs

This directory is the local standards index for `sdkwork-models`.
...
| Name | `sdkwork-models` |
| Type | `rust-crate` |
| Root | `sdks/sdkwork-models-sdk/sdkwork-models-sdk-rust` |
| Domain | `intelligence` |
| Capability | `model` |
| Languages | `rust` |
...
- `cargo test --manifest-path apps/sdks/sdkwork-models-sdk/sdkwork-models-sdk-rust/Cargo.toml`
