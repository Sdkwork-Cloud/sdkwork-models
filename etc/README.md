# sdkwork-models Source Configuration
...
| `runtimeCode` | `models` |
| Config root | `/etc/sdkwork/models/` |
| Runtime TOML | `/etc/sdkwork/models/config.toml` |
| Secrets | `/etc/sdkwork/models/secrets/` |
| Override | `SDKWORK_MODELS_CONFIG_FILE` |
