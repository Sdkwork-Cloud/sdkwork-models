...
pub fn catalog_backend_router_with_sqlite_pool_and_catalog(
    ...
    catalog_backend_router_with_stores(admin_store, read_store, refresh_store, ai_resource_store, voice_catalog)
}
...
pub fn catalog_backend_router_with_stores(
    ...
    let mut router = admin_model_management_router_with_store(admin_store, CatalogEntityUuidGenerator::arc())
