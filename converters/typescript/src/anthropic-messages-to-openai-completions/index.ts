...
export class AnthropicMessagesToOpenAiCompletionsConverter implements Converter {
  ...
  name(): string { return 'ANTHROPIC_MESSAGES_TO_OPENAI_COMPLETIONS'; }
  ...
  capabilities(): Capability[] { return ['stream', 'tools', 'code', 'reasoning'] as Capability[]; }
  ...
  async convertRequest(request: ConversionRequest): Promise<ConversionRequest> {
    ...
    return { ...request, protocol: this.targetProtocol(), model, messages, maxTokens: request.maxTokens ?? 4096 };
  }
