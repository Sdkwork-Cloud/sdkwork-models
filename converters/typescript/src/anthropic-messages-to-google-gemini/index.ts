...
export class AnthropicMessagesToGoogleGeminiConverter implements Converter {
  ...
  name(): string { return 'ANTHROPIC_MESSAGES_TO_GOOGLE_GEMINI'; }
  ...
  async convertRequest(request: ConversionRequest): Promise<ConversionRequest> {
    ...
    return { ...request, protocol: this.targetProtocol(), model, messages, tools: undefined, system: undefined };
  }
