...
pub struct OpenAiResponsesToGoogleGeminiConverter {
    model_mapping: ModelMapping,
}

impl OpenAiResponsesToGoogleGeminiConverter {
    pub fn new(model_mapping: ModelMapping) -> Self { Self { model_mapping } }
}

impl Default for OpenAiResponsesToGoogleGeminiConverter {
    fn default() -> Self { Self::new(ModelMapping::default()) }
}

#[async_trait]
impl Converter for OpenAiResponsesToGoogleGeminiConverter {
    fn name(&self) -> &str { "OPENAI_RESPONSES_TO_GOOGLE_GEMINI" }
